...
begin
  ...
  { cases x,
    simp only [chart_at, basic_smooth_bundle_core.chart, topological_fiber_bundle_core.local_triv,
      ...
      basic_smooth_bundle_core.to_topological_fiber_bundle_core, A, equiv.coe_refl] with mfld_simps },
  ...
  { rintros ⟨x_fst, x_snd⟩,
    simp only [chart_at, basic_smooth_bundle_core.chart, topological_fiber_bundle_core.local_triv,
      ...
      basic_smooth_bundle_core.to_topological_fiber_bundle_core, equiv.coe_refl] with mfld_simps },
