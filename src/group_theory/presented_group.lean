...
subgroup.normal_closure_le_normal (monoid_hom.normal_ker _) (λ x w, monoid_hom.mem_ker.2 (h x w))
...
λ x, quotient_group.induction_on x
    (λ _, free_group.to_group.unique (g.comp (quotient_group.mk_hom _)) hg)
